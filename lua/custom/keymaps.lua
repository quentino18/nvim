...
vim.keymap.set('n', '<F8>', ':%s#\\<<c-r><c-w>\\>#<c-r><c-w>#gc', { desc = 'Replace string' })
...
-- COMMON DIE METHODS--------------------------------------------------------
vim.keymap.set('n', '<leader>cad', ':!bash /produits/qco/cmd_check.sh -c %<CR>', { desc = 'Commmon die check', noremap = true, silent = true })
...
ls.add_snippets('c', {
  snip(
    { trig = 'ptf', dscr = 'STD Debug printf' },
    { t 'printf("[DEBUG] %s:%d: ', i(1, ''), t ' %d\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'bptf', dscr = 'BLUE Debug printf' },
    { t 'printf("\\x1B[1;44m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'rptf', dscr = 'RED Debug printf' },
    { t 'printf("\\x1B[1;41m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'gptf', dscr = 'GREEN Debug printf' },
    { t 'printf("\\x1B[1;42;30m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'yptf', dscr = 'YELLOW Debug printf' },
    { t 'printf("\\x1B[1;43;30m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'vptf', dscr = 'PURPLE Debug printf' },
    { t 'printf("\\x1B[1;35m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),
  snip(
    { trig = 'wptf', dscr = 'WHITE Debug printf' },
    { t 'printf("\\x1B[1;100m[DEBUG] %s:%d: ', i(1, ''), t ' %d\\x1B[0m\\n", __FUNCTION__, __LINE__, ', i(2, 'var'), t ');', i(0) }
  ),

  -- snip({trig = "cdz",  dscr = "common_die_zero"}, { t'common_die_zero( ret, -1, ', t'"Error ', i(1, 'function'), t' return %d", ret', t');', i(0)}),
  -- snip({trig = "cdn",  dscr = "common_die_null"}, { t'common_die_null( ', i(1, 'ret'), t' -1, "Error ', i(2, 'function'), t' return %d", ', i(3, 'ret'), t');', i(0)}),
